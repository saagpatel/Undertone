...
- [ ] PASS iff `pnpm test src/dsp/quantize.test.ts` exits 0 — A4 at 440 Hz + 400 ms duration quantizes to `{ pitch: 'A', accidental: null, octave: 4, noteValue: 'quarter', beatPosition: 0 }` at 90 BPM.
